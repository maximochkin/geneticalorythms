...
public class FitnessHierarchyFinalModel implements FitnessFunction {
	...
	private List<Double> coefficientsFromSubModels;
	...
	public void setCoefficientsFromSubModels(List<Double> coefficients) {
		this.coefficientsFromSubModels = coefficients;
	}
}
